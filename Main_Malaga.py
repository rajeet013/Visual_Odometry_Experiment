...
malaga_path = "F:/PycharmProjects/Visual Odometry Project/malaga-urban-dataset-extract-07"
...
if ds == 0:
    ...
    assert 'malaga_path' in locals(), "F:/PycharmProjects/Visual Odometry Project/malaga-urban-dataset-extract-07"
